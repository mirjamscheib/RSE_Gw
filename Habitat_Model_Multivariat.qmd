...
# save as .tif -------------------------------------------
writeRaster(HS_barbus_v_impaired_0106, filename="results_univariate/n_HS_barbus_v_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(HS_barbus_v_impaired_0805, filename="results_univariate/n_HS_barbus_v_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(HS_barbus_v_restored_0106, filename="results_univariate/n_HS_barbus_v_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(HS_barbus_v_restored_0805, filename="results_univariate/n_HS_barbus_v_restored_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(HS_rhithrogena_v_impaired_0106, filename="results_univariate/n_HS_rhithrogena_v_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(HS_rhithrogena_v_impaired_0805, filename="results_univariate/n_HS_rhithrogena_v_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(HS_rhithrogena_v_restored_0106, filename="results_univariate/n_HS_rhithrogena_v_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(HS_rhithrogena_v_restored_0805, filename="results_univariate/n_HS_rhithrogena_v_restored_0805.tif", format="GTiff", overwrite=TRUE)
```
...
# save as .tif -------------------------------------------
writeRaster(GHSI_barbus_impaired_0106, filename="results_multivariate/n_GHSI_barbus_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_barbus_impaired_0805, filename="results_multivariate/n_GHSI_barbus_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_barbus_restored_0106, filename="results_multivariate/n_GHSI_barbus_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_barbus_restored_0805, filename="results_multivariate/n_GHSI_barbus_restored_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_rhithrogena_impaired_0106, filename="results_multivariate/n_GHSI_rhithrogena_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_rhithrogena_impaired_0805, filename="results_multivariate/n_GHSI_rhithrogena_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_rhithrogena_restored_0106, filename="results_multivariate/n_GHSI_rhithrogena_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_rhithrogena_restored_0805, filename="results_multivariate/n_GHSI_rhithrogena_restored_0805.tif", format="GTiff", overwrite = TRUE)
```
...
# save as .tif -------------------------------------------
writeRaster(GHSI_classes_barbus_impaired_0106, filename="results_multivariate/n_GHSI_classes_barbus_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_classes_barbus_impaired_0805, filename="results_multivariate/n_GHSI_classes_barbus_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_classes_barbus_restored_0106, filename="results_multivariate/n_GHSI_classes_barbus_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_classes_barbus_restored_0805, filename="results_multivariate/n_GHSI_classes_barbus_restored_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_classes_rhithrogena_impaired_0106, filename="results_multivariate/n_GHSI_classes_rhithrogena_impaired_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_classes_rhithrogena_impaired_0805, filename="results_multivariate/n_GHSI_classes_rhithrogena_impaired_0805.tif", format="GTiff", overwrite=TRUE)

writeRaster(GHSI_classes_rhithrogena_restored_0106, filename="results_multivariate/n_GHSI_classes_rhithrogena_restored_0106.tif", format="GTiff", overwrite=TRUE)
writeRaster(GHSI_classes_rhithrogena_restored_0805, filename="results_multivariate/n_GHSI_classes_rhithrogena_restored_0805.tif", format="GTiff", overwrite=TRUE)
```
...
july <- as.POSIXct("06-01", format = "%m%d", tz = "UTC")
...
results <- data.frame(Description = c("Barbus_impaired", "Barbus_impaired", "Barbus_restored", "Barbus_restored", "Rhithrogena_impaired", "Rhithrogena_impaired", "Rhithrogena_restored", "Rhithrogena_restored"), 
                      Date = as.POSIXct(july, may, july, may, july, may, july, may),
...
ggplot(WUA_HHS, aes(Discharge, WUA, col = Description)) +
  geom_point(size = 2) +
  geom_line() +
  labs(title = "Comparing Weighted Usable Area (WUA) between Barbus barbus and Rhithrogena Eaton (larva)", x = expression(paste("Discharge [", m^3/s, "]")), y = "WUA", col = "Species") +
  theme_gray()
